...
describe('MetricoolApi Credentials', () => {
    ...
    it('should not expose credentials in query string globally', () => {
        const auth = credentials.authenticate;
        // Credentials should NOT be in global query string
        // userId will be added manually only in v2 endpoints that need it
